...
class BroadcastsTableSeeder extends Seeder
{
    ...
    {
    		$broadcasts = [ 
    			['name' => 'Monday 7:00am', 'day' => 'monday', 'time' => '07:00:00'],
    			...
    			['name' => 'Thursday 12:16am', 'description' => 'Live from Woodway', 'day' => 'thursday', 'time' => '00:16:00', 'live' => true, 'embed_code' => '<div id="la1-video-player" data-embed-id="f87344c6-2e5a-49fa-8dc2-863a8ca08453"></div>'],
				['name' => 'Thursday 3:00am', 'day' => 'thursday', 'time' => '03:00:00'],
				...
				['name' => 'Sunday Worship 11:00am', 'day' => 'sunday', 'time' => '11:00:00', 'live' => true, 'embed_code' => '<div id="la1-video-player" data-embed-id="f87344c6-2e5a-49fa-8dc2-863a8ca08453"></div>'],
            ];
